...
wget -nc https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Wine/Release.key
...
sudo wget -O ~/.wine/drive_c/windows/Fonts/simhei.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/simhei.ttf
sudo wget -O ~/.wine/drive_c/windows/Fonts/simkai.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/simkai.ttf
sudo wget -O ~/.wine/drive_c/windows/Fonts/SIMLI.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/SIMLI.ttf
sudo wget -O ~/.wine/drive_c/windows/Fonts/simsun.ttc https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/simsun.ttc
sudo wget -O ~/.wine/drive_c/windows/Fonts/SIMYOU.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/SIMYOU.ttf
sudo wget -O ~/.wine/drive_c/windows/Fonts/仿宋_GB2312.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/仿宋_GB2312.ttf
sudo wget -O ~/.wine/drive_c/windows/Fonts/楷体_GB2312.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Wine/楷体_GB2312.ttf
useradd -m RdpUser
echo "cxthhhhh.com
cxthhhhh.com
" | passwd RdpUser
...
echo -e "\n"
cd /root
sudo wget -O ~/Libpng12-0.deb https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/WPS/Debian/libpng12-0_1.2.50-2+deb8u3_amd64.deb
sudo dpkg -i ~/Libpng12-0.deb
sudo wget -O ~/WPS-Office.deb https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/WPS/wps-office_10.1.0.5707_a21_amd64.deb
sudo dpkg -i ~/WPS-Office.deb
sudo wget -O ~/WPS-Office-Fonts.deb https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/WPS/wps-office-fonts_1.0_all.deb
...
sudo wget -O /usr/share/fonts/wingding.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Sys/wingding.ttf
sudo wget -O /usr/share/fonts/WINGDNG2.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Sys/WINGDNG2.ttf
sudo wget -O /usr/share/fonts/WINGDNG3.ttf https://cdn.jsdelivr.net/gh/ciweiin/Linux-Remote-Desktop@latest/CNDownload/Common/Fonts/TTF-Sys/WINGDNG3.ttf
sudo mkfontscale
sudo mkfontdir
sudo fc-cache
echo "---------------------------------------------------------------------------------------------------------------------"
